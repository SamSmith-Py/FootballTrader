...
def export_cumulative_pnl(
    ...
    # Optional: stable tie-breaker if you have event identifiers
    tie_cols = []
...
# ===================== MAIN =====================
def main():
    """Run backtest and write CSV outputs + history row."""
    ...
    # Flow: filter by date -> parse scores -> identify leagues -> compute PnL -> export CSVs.
    ...
    # "comp" is the league/competition key in archive_v2.
    ...
    # Entry 1: pre-match LTD if odds are acceptable
    ...
    # Entry 2: only if late-goal league AND 0-0 at 60
